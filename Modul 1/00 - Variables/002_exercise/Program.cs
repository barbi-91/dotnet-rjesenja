/*
 * Using basic variables and arithmetic operators write a simple program 
 * that takes 
 * distance and time 
 * as inputs
...
// (in this example input validation is not required,
// the user is expected to enter an integer or float value type)
...
// Insert your code logic here to calculate speed in kilometers per hour
kilometres_per_hour = (distance / 1000) / (hour + (minutes / 60) + (seconds / 3600));
// and miles per hour
miles_per_hour = kilometres_per_hour * 0.62142F;
