 ...
 * and the Console.ReadLine() command 
 * save two values, 
 * then assign variable "a" the entered value of variable "b" 
 * and assign variable "b" the entered value of variable "a"
 */

// Here we have basic logic to insert data
// (in this example input validation is not required, the user is
// expected to enter an integer values)
